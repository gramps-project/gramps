...
class WelcomeRelview(Gramplet):
    ...
    def display_text(self):
        ...
        welcome = boldst(_('Getting Started')) + '\n\n' + _(
            'To start entering your family history you will need to'
            'create a new Family Tree (sometimes called a \'database\').'
            'From the menu select "Family Trees" >"Manage Family Trees"'
            'and then press the "New" button and name your Family Tree.'
            'Visit the \'Online help link below.\' to learn more.\n\n')
        welcome += boldst(_('Relationships Category view')) + '\n\n' + _(
            'You are currently reading from the "Relationships" view, which'
            'if available, displays all the relationships of the Active Person'
        ...
        welcome += _(
            'Gramps is a software program designed for genealogical research.'
