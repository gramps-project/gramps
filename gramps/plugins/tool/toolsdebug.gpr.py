...
register(
    ...
    description=_("This tool generates sources and citations for each source "
                  "in order to populate the database for testing with "
                  "significant numbers of sources and citations."),
    version='1.0',
    gramps_target_version=MODULE_VERSION,
    status=UNSTABLE,
