...
register(
    ...
    description=(
        "This test tool will create many people showing all"
...
register(
    ...
    description=_(
        "Will dump the statistics for guessing the gender " "from the first name."
    ),
    version="1.0",
    gramps_target_version=MODULE_VERSION,
    status=STABLE,
...
register(
    ...
    description=(
        "The testcase generator will generate some persons "
...
register(
    ...
    description=(
        "This tool generates sources and citations for each source in "
