...
TOOLS_HELP = _("Gramps_5.2_Wiki_Manual_-_Navigation#Tools")
...
register(
    ...
    description=_(
        "Aids in the analysis of data by allowing the "
...
register(
    ...
    description=_("Searches the entire database, looking for " "a possible loop."),
    version="1.0",
    gramps_target_version=MODULE_VERSION,
    status=STABLE,
    fname="findloop.py",
