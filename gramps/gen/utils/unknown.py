...
#
# -------------------------------------------------------------------------
def make_unknown(class_arg, explanation, class_func, commit_func, transaction, **argv):
    """
    ...
    if isinstance(obj, Person):
        ...
        obj.set_name(
            _("Unknown, was missing %(time)s (%(count)d)")
...
def create_explanation_note(dbase):
    ...
    """
    note = Note(
        _("Objects referenced by this note " "were missing in a file imported on %s.")
