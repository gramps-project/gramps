...
register('spacing.selector.citation', [])
register('spacing.selector.event', [])
register('spacing.selector.family', [])
register('spacing.selector.media', [])
register('spacing.selector.note', [])
register('spacing.selector.person', [])
register('spacing.selector.place', [])
register('spacing.selector.repo', [])
register('spacing.selector.source', [])

register('spacing.embeddedlist.addr', [])
register('spacing.embeddedlist.attr', [])
register('spacing.embeddedlist.backref', [])
register('spacing.embeddedlist.child', [])
register('spacing.embeddedlist.citation', [])
register('spacing.embeddedlist.eventattr', [])
register('spacing.embeddedlist.event', [])
register('spacing.embeddedlist.familyattr', [])
register('spacing.embeddedlist.familylds', [])
register('spacing.embeddedlist.lds', [])
register('spacing.embeddedlist.location', [])
register('spacing.embeddedlist.mediaattr', [])
register('spacing.embeddedlist.name', [])
register('spacing.embeddedlist.note', [])
register('spacing.embeddedlist.person', [])
register('spacing.embeddedlist.placename', [])
register('spacing.embeddedlist.place', [])
register('spacing.embeddedlist.repo', [])
register('spacing.embeddedlist.srcattr', [])
register('spacing.embeddedlist.web', [])
