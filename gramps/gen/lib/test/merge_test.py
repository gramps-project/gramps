...
class PlaceCheck(
    ...
    def test_merge_primary_different(self):
        ...
        self.ref_obj.set_name(self.amsterdam)
        self.ref_obj.set_type("City")
        self.ref_obj.add_name(self.rotterdam)
        self.phoenix.merge(self.titanic)
        self.assertEqual(self.phoenix.serialize(), self.ref_obj.serialize())
    ...
    def test_merge_both_different(self):
        self.phoenix.set_name(self.amsterdam)
        self.phoenix.set_type("City")
        self.phoenix.add_name(self.utrecht)
        self.titanic.set_title("Place 2")
        self.titanic.set_name(self.rotterdam)
        self.titanic.set_type("City")
        self.titanic.add_name(self.leiden)
        self.ref_obj.set_name(self.amsterdam)
        self.ref_obj.set_type("City")
        # names must be in correct order for test to pass
        self.ref_obj.add_name(self.utrecht)
        self.ref_obj.add_name(self.rotterdam)
        self.ref_obj.add_name(self.leiden)
        self.phoenix.merge(self.titanic)
        self.assertEqual(self.phoenix.serialize(), self.ref_obj.serialize())

    def test_merge_both_different_sort_date(self):
        self.amsterdam.date = _dp.parse("before 1960")
        self.phoenix.set_name(self.amsterdam)
        self.utrecht.date = _dp.parse("from 1960 to 1970")
        self.phoenix.add_name(self.utrecht)
        ptype1 = PlaceType("Hamlet", date=_dp.parse("before 1960"))
        self.phoenix.set_type(ptype1)
        ptype2 = PlaceType("Village", date=_dp.parse("from 1960 to 1970"))
        self.phoenix.add_type(ptype2)
        self.titanic.set_title("Place 2")
        self.rotterdam.date = _dp.parse("after 1980")
        self.titanic.set_name(self.rotterdam)
        self.leiden.date = _dp.parse("from 1970 to 1980")
        self.titanic.add_name(self.leiden)
        ptype3 = PlaceType("City", date=_dp.parse("after 1980"))
        self.titanic.set_type(ptype3)
        ptype4 = PlaceType("Town", date=_dp.parse("from 1970 to 1980"))
        self.titanic.add_type(ptype4)
        # names must be in correct order for test to pass
        self.ref_obj.set_name(self.rotterdam)
        self.ref_obj.add_name(self.utrecht)
        self.ref_obj.add_name(self.amsterdam)
        self.ref_obj.add_name(self.leiden)
        self.ref_obj.add_type(ptype3)
        self.ref_obj.add_type(ptype2)
        self.ref_obj.add_type(ptype1)
        self.ref_obj.add_type(ptype4)
        self.phoenix.merge(self.titanic)
        self.assertEqual(self.phoenix.serialize(), self.ref_obj.serialize())

    def test_merge_both_different_sort_lang(self):
        self.amsterdam.lang = "de"
        self.phoenix.set_name(self.amsterdam)
        self.utrecht.lang = "fi"
        self.phoenix.add_name(self.utrecht)
        self.phoenix.set_type("City")
        self.titanic.set_title("Place 2")
        self.titanic.set_name(self.rotterdam)
    ...
    def test_merge_alternative_identical(self):
        self.phoenix.set_name(self.amsterdam)
        self.phoenix.set_type("City")
        self.phoenix.add_name(self.rotterdam)
        self.titanic.set_title("Place 2")
        self.titanic.set_name(self.amsterdam)
        self.titanic.set_type("City")
        self.titanic.add_name(self.rotterdam)
        self.ref_obj.set_name(self.amsterdam)
        self.ref_obj.set_type("City")
        self.ref_obj.add_name(self.rotterdam)
        self.phoenix.merge(self.titanic)
    ...
    def test_merge_alternative_different(self):
        ...
        self.titanic.set_name(self.amsterdam)
        self.titanic.set_type("City")
        self.titanic.add_name(self.utrecht)
        self.ref_obj.set_name(self.amsterdam)
        self.ref_obj.set_type("City")
        self.ref_obj.add_name(self.rotterdam)
        self.ref_obj.add_name(self.utrecht)
    ...
    def test_merge_prialt2(self):
        ...
        self.titanic.set_name(self.rotterdam)
        self.titanic.set_type("City")
        self.titanic.add_name(self.amsterdam)
        self.ref_obj.set_name(self.amsterdam)
        self.ref_obj.set_type("City")
        self.ref_obj.add_name(self.rotterdam)
        self.phoenix.merge(self.titanic)
    ...
    def test_merge_empty(self):
        ...
        self.titanic.set_type("City")
        self.titanic.add_name(self.utrecht)
        self.titanic.add_name(PlaceName())  # empty alt_name
        self.ref_obj.set_name(self.amsterdam)
        self.ref_obj.set_type("City")
        self.ref_obj.add_name(self.rotterdam)
        self.ref_obj.add_name(self.utrecht)
