    ...
    def __init__(self, source=None, **kwargs):
        ...
        for key in kwargs:
            if key in ["value", "type"]:
                ...
                raise AttributeError("PlaceAbbrev does not have property '%s'" % key)

    def serialize(self):
        """
        Convert the object to a serialized tuple of data.
        """
        return (self.value, self.type.serialize())

    def unserialize(self, data):
        """
        Convert a serialized tuple of data to an object.
        """
        (self.value, the_type) = data
        self.type = PlaceAbbrevType()
    ...
    def get_schema(cls):
        ...
        return {
            ...
            "properties": {
                ...
                "type": PlaceAbbrevType.get_schema(),
            },
        }
