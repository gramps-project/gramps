...
@unittest.skipUnless(
    HAS_CLIMERGE and HAS_EXPORTRAW,
...
class BaseMergeCheck(unittest.TestCase):
    ...
    def do_case(self, phoenix_id, titanic_id, input_doc, expect_doc, test_error_str=""):
        ...
        result_str, err_str = gramps.run(
            ...
            "-f",
            "gramps",
            stdin=BytesIO(input_doc),
            bytesio=True,
        )
        self.check_results(input_doc, expect_doc, result_str, err_str, test_error_str)
    ...
    def raw_contains(
        self, phoenix_id, titanic_id, input_doc, expect_str, test_error_str=""
    ):
        gramps = Gramps(user=User())
        result_str, err_str = gramps.run(
            "-d",
...
class PersonCheck(BaseMergeCheck):
    ...
    def test_event_merge(self):
        ...
        eventref = expect.xpath(
            "//g:person[@handle='_i0001']/g:eventref", namespaces={"g": NS_G}
        )[0]
    ...
    def test_place_merge(self):
        ...
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        place = expect.xpath(
            "//g:person[@handle='_i0001']/g:lds_ord/g:place", namespaces={"g": NS_G}
        )[0]
        place.attrib["hlink"] = "_p0000"
        placeobj = expect.xpath(
            "//g:placeobj[@handle='_p0001']", namespaces={"g": NS_G}
        )[0]
    ...
    def test_citation_merge(self):
        ...
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        srcref = expect.xpath(
            "//g:person[@handle='_i0001']/g:citationref", namespaces={"g": NS_G}
        )[0]
        srcref.attrib["hlink"] = "_c0000"
        citation = expect.xpath(
    ...
    def test_media_merge(self):
        ...
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        objref = expect.xpath(
            "//g:person[@handle='_i0001']/g:objref", namespaces={"g": NS_G}
        )[0]
        objref.attrib["hlink"] = "_o0000"
        object_ = expect.xpath("//g:object[@handle='_o0001']", namespaces={"g": NS_G})[
            0
        ]
    ...
    def test_note_merge(self):
        """Merge two notes"""
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        noteref = expect.xpath(
            "//g:person[@handle='_i0001']/g:noteref", namespaces={"g": NS_G}
        )[0]
    ...
    def test_repository_merge(self):
        ...
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        reporef = expect.xpath(
            "//g:source[@handle='_s0001']/g:reporef", namespaces={"g": NS_G}
        )[0]
        reporef.attrib["hlink"] = "_r0000"
        object_ = expect.xpath(
            "//g:repository[@handle='_r0001']", namespaces={"g": NS_G}
        )[0]
        object_.getparent().remove(object_)
...
class FamilyCheck(BaseMergeCheck):
    ...
    def test_event_merge(self):
        ...
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        eventref = expect.xpath(
            "//g:family[@handle='_f0001']/g:eventref", namespaces={"g": NS_G}
        )[0]
        eventref.attrib["hlink"] = "_e0000"
        event = expect.xpath("//g:event[@handle='_e0001']", namespaces={"g": NS_G})[0]
        event.getparent().remove(event)
    ...
    def test_place_merge(self):
        ...
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        place = expect.xpath(
            "//g:family[@handle='_f0001']/g:lds_ord/g:place", namespaces={"g": NS_G}
        )[0]
        place.attrib["hlink"] = "_p0000"
        placeobj = expect.xpath(
            "//g:placeobj[@handle='_p0001']", namespaces={"g": NS_G}
    ...
    def test_citation_merge(self):
        ...
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        citref = expect.xpath(
            "//g:family[@handle='_f0001']/g:citationref", namespaces={"g": NS_G}
        )[0]
    ...
    def test_media_merge(self):
        ...
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        objref = expect.xpath(
            "//g:family[@handle='_f0001']/g:objref", namespaces={"g": NS_G}
        )[0]
        objref.attrib["hlink"] = "_o0000"
        object_ = expect.xpath("//g:object[@handle='_o0001']", namespaces={"g": NS_G})[
            0
    ...
    def test_note_merge(self):
        ...
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        noteref = expect.xpath(
            "//g:family[@handle='_f0001']/g:noteref", namespaces={"g": NS_G}
        )[0]
        noteref.attrib["hlink"] = "_n0000"
        note = expect.xpath("//g:note[@handle='_n0001']", namespaces={"g": NS_G})[0]
        note.getparent().remove(note)
...
class EventCheck(BaseMergeCheck):
    ...
    def test_place_merge(self):
        ...
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        place = expect.xpath(
            "//g:event[@handle='_e0001']/g:place", namespaces={"g": NS_G}
        )[0]
        place.attrib["hlink"] = "_p0000"
        placeobj = expect.xpath(
            "//g:placeobj[@handle='_p0001']", namespaces={"g": NS_G}
    ...
    def test_citation_merge(self):
        ...
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        citref = expect.xpath(
            "//g:event[@handle='_e0001']/g:citationref", namespaces={"g": NS_G}
        )[0]
        citref.attrib["hlink"] = "_c0000"
        citation = expect.xpath(
            "//g:citation[@handle='_c0001']", namespaces={"g": NS_G}
    ...
    def test_media_merge(self):
        ...
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        objref = expect.xpath(
            "//g:event[@handle='_e0001']/g:objref", namespaces={"g": NS_G}
        )[0]
        objref.attrib["hlink"] = "_o0000"
        object_ = expect.xpath("//g:object[@handle='_o0001']", namespaces={"g": NS_G})[
            0
    ...
    def test_note_merge(self):
        ...
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        noteref = expect.xpath(
            "//g:event[@handle='_e0001']/g:noteref", namespaces={"g": NS_G}
        )[0]
        noteref.attrib["hlink"] = "_n0000"
        note = expect.xpath("//g:note[@handle='_n0001']", namespaces={"g": NS_G})[0]
        note.getparent().remove(note)
...
class PlaceCheck(BaseMergeCheck):
    ...
    def test_citation_merge(self):
        ...
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        citref = expect.xpath(
            "//g:placeobj[@handle='_p0001']/g:citationref", namespaces={"g": NS_G}
        )[0]
        citref.attrib["hlink"] = "_c0000"
        citation = expect.xpath(
            "//g:citation[@handle='_c0001']", namespaces={"g": NS_G}
    ...
    def test_media_merge(self):
        ...
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        objref = expect.xpath(
            "//g:placeobj[@handle='_p0001']/g:objref", namespaces={"g": NS_G}
        )[0]
        objref.attrib["hlink"] = "_o0000"
        object_ = expect.xpath("//g:object[@handle='_o0001']", namespaces={"g": NS_G})[
            0
    ...
    def test_note_merge(self):
        ...
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        noteref = expect.xpath(
            "//g:placeobj[@handle='_p0001']/g:noteref", namespaces={"g": NS_G}
        )[0]
        noteref.attrib["hlink"] = "_n0000"
        note = expect.xpath("//g:note[@handle='_n0001']", namespaces={"g": NS_G})[0]
        note.getparent().remove(note)
...
class SourceCheck(BaseMergeCheck):
    ...
    def test_repo_merge(self):
        ...
        repo = expect.xpath("//g:repository[@handle='_r0001']", namespaces={"g": NS_G})[
            0
        ]
    ...
    def test_media_merge(self):
        ...
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        objref = expect.xpath(
            "//g:source[@handle='_s0001']/g:objref", namespaces={"g": NS_G}
        )[0]
        objref.attrib["hlink"] = "_o0000"
        object_ = expect.xpath("//g:object[@handle='_o0001']", namespaces={"g": NS_G})[
            0
    ...
    def test_note_merge(self):
        ...
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        noteref = expect.xpath(
            "//g:source[@handle='_s0001']/g:noteref", namespaces={"g": NS_G}
        )[0]
        noteref.attrib["hlink"] = "_n0000"
        note = expect.xpath("//g:note[@handle='_n0001']", namespaces={"g": NS_G})[0]
        note.getparent().remove(note)
...
class RepoCheck(BaseMergeCheck):
    ...
    def test_citation_merge(self):
        ...
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        citref = expect.xpath(
            "//g:repository[@handle='_r0001']" "/g:address/g:citationref",
            namespaces={"g": NS_G},
        )[0]
        citref.attrib["hlink"] = "_c0000"
        citation = expect.xpath(
    ...
    def test_note_merge(self):
        ...
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        noteref = expect.xpath(
            "//g:repository[@handle='_r0001']/g:noteref", namespaces={"g": NS_G}
        )[0]
        noteref.attrib["hlink"] = "_n0000"
        note = expect.xpath("//g:note[@handle='_n0001']", namespaces={"g": NS_G})[0]
        note.getparent().remove(note)
...
class MediaCheck(BaseMergeCheck):
    ...
    def test_citation_merge(self):
        ...
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        citref = expect.xpath(
            "//g:object[@handle='_o0001']/g:citationref", namespaces={"g": NS_G}
        )[0]
        citref.attrib["hlink"] = "_c0000"
        citation = expect.xpath(
            "//g:citation[@handle='_c0001']", namespaces={"g": NS_G}
    ...
    def test_note_merge(self):
        ...
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        noteref = expect.xpath(
            "//g:object[@handle='_o0001']/g:noteref", namespaces={"g": NS_G}
        )[0]
        noteref.attrib["hlink"] = "_n0000"
        note = expect.xpath("//g:note[@handle='_n0001']", namespaces={"g": NS_G})[0]
        note.getparent().remove(note)
...
class FamilyPersonCheck(BaseMergeCheck):
    ...
    def test_multi_rel(self):
        ...
        families = expect.xpath("//g:families", namespaces={"g": NS_G})[0]
        family = ET.SubElement(families, NSP + "family", handle="_f0002", id="F0002")
        ...
        ET.SubElement(family, NSP + "father", hlink="_i0002")
        ET.SubElement(family, NSP + "mother", hlink="_i0003")
        families = input_ctxt.xpath("//g:families", namespaces={"g": NS_G})[0]
        family = ET.SubElement(families, NSP + "family", handle="_f0002", id="F0002")
        ET.SubElement(family, NSP + "rel", type="Married")
        ET.SubElement(family, NSP + "father", hlink="_i0002")
        ET.SubElement(family, NSP + "mother", hlink="_i0003")
        input_doc = ET.tostring(input_ctxt)
        self.do_case("I0000", "I0002", input_doc, expect, test_error_str="")
    ...
    def test_merge_fam(self):
        ...
        parentin = expect.xpath(
            "//g:person[@handle='_i0001']/g:parentin", namespaces={"g": NS_G}
        )[1]
    ...
    def test_fam_none_merge(self):
        ...
        input_ctxt = ET.fromstring(self.basedoc, parser=self.parser)
        parentin = input_ctxt.xpath(
            "//g:person[@handle='_i0001']/g:parentin", namespaces={"g": NS_G}
        )[0]
        parentin.getparent().remove(parentin)
        mother = input_ctxt.xpath(
            "//g:family[@handle='_f0000']/g:mother", namespaces={"g": NS_G}
        )[0]
    ...
    def test_fam_mother_merge(self):
        ...
        expect = copy.deepcopy(input_ctxt)
        persons = expect.xpath("//g:person", namespaces={"g": NS_G})
        altname = ET.SubElement(persons[1], NSP + "name", alt="1", type="Birth Name")
        ET.SubElement(altname, NSP + "surname").text = "Person 3"
        attr = ET.SubElement(
            persons[1], NSP + "attribute", type="Merged Gramps ID", value="I0003"
        )
        parentref = expect.xpath(
            "//g:person[@handle='_i0001']/g:parentin", namespaces={"g": NS_G}
        )[0]
        ...
        notetag.attrib["value"] = "gramps://Family/handle/f0000"
        notetag = expect.xpath(
            "//g:note[@handle='_n0003']/g:style", namespaces={"g": NS_G}
        )[0]
    ...
    def test_childref_notyet(self):
        ...
        families = input_ctxt.xpath("//g:family", namespaces={"g": NS_G})
        ...
        notetag.attrib["value"] = "gramps://Family/handle/f0000"
        families = expect.xpath("//g:family", namespaces={"g": NS_G})
        families[1].getparent().remove(families[1])
        childof = expect.xpath(
            "//g:person[@handle='_i0003']/g:childof", namespaces={"g": NS_G}
        )[0]
    ...
    def test_childref_already(self):
        ...
        families[1].getparent().remove(families[1])
        childof = expect.xpath(
            "//g:person[@handle='_i0001']/g:childof", namespaces={"g": NS_G}
        )
    ...
    def test_ldsord(self):
        ...
        ET.SubElement(family, NSP + "father", hlink="_i0002")
        ldsord = ET.SubElement(persons[3], NSP + "lds_ord", type="sealed_to_parents")
    ...
    def test_ldsord_cross(self):
        ...
        ET.SubElement(family, NSP + "father", hlink="_i0002")
        ldsord = ET.SubElement(persons[0], NSP + "lds_ord", type="sealed_to_parents")
        ET.SubElement(ldsord, NSP + "sealed_to", hlink="_f0001")
        expect = copy.deepcopy(input_ctxt)
        persons = expect.xpath("//g:person", namespaces={"g": NS_G})
        altname = ET.SubElement(persons[0], NSP + "name", alt="1", type="Birth Name")
        ET.SubElement(altname, NSP + "surname").text = "Person 2"
        ldsord = expect.xpath("//g:lds_ord", namespaces={"g": NS_G})[0]
    ...
    def test_ldsord_self(self):
        ...
        ET.SubElement(family, NSP + "father", hlink="_i0002")
        ldsord = ET.SubElement(persons[2], NSP + "lds_ord", type="sealed_to_parents")
        ET.SubElement(ldsord, NSP + "sealed_to", hlink="_f0001")
        expect = copy.deepcopy(input_ctxt)
        persons = expect.xpath("//g:person", namespaces={"g": NS_G})
        altname = ET.SubElement(persons[0], NSP + "name", alt="1", type="Birth Name")
...
class FamilyMergeCheck(BaseMergeCheck):
    ...
    def test_father_son_merge(self):
        ...
        family = input_ctxt.xpath(
            "//g:family[@handle='_f0000']", namespaces={"g": NS_G}
        )[0]
    ...
    def test_child_parent_merge_no_father(self):
        ...
        input_ctxt = ET.fromstring(self.basedoc, parser=self.parser)
        parentin = input_ctxt.xpath(
            "//g:person[@handle='_i0002']/g:parentin", namespaces={"g": NS_G}
        )[0]
        parentin.getparent().remove(parentin)
        father = input_ctxt.xpath(
            "//g:family[@handle='_f0001']/g:father", namespaces={"g": NS_G}
        )[0]
    ...
    def test_father_swapped(self):
        ...
        expect = ET.fromstring(self.basedoc, parser=self.parser)
        persons = expect.xpath("//g:person", namespaces={"g": NS_G})
        altname = ET.SubElement(persons[2], NSP + "name", alt="1", type="Birth Name")
        ET.SubElement(altname, NSP + "surname").text = "Person 0"
        attr = ET.SubElement(
            persons[2], NSP + "attribute", type="Merged Gramps ID", value="I0000"
        )
        parentref = expect.xpath(
            "//g:person[@handle='_i0002']/g:parentin", namespaces={"g": NS_G}
        )[0]
    ...
    def test_no_father(self):
        ...
        notetag.attrib["value"] = "gramps://Family/handle/f0000"
        input_doc = ET.tostring(input_ctxt)
        self.do_family_case("F0000", "F0001", "i0000", "i0001", input_doc, expect)
    ...
    def test_no_mother_swapped(self):
        ...
        persons[2].getparent().remove(persons[2])
        parentin = expect.xpath(
            "//g:person[@handle='_i0003']/g:parentin", namespaces={"g": NS_G}
        )[0]
        ...
        input_doc = ET.tostring(input_ctxt)
        self.do_family_case("F0000", "F0001", "i0000", "i0003", input_doc, expect)
    ...
    def test_childref_notyet(self):
        ...
        input_ctxt = ET.fromstring(self.basedoc, parser=self.parser)
        people = input_ctxt.xpath("//g:people", namespaces={"g": NS_G})[0]
        person = ET.SubElement(people, NSP + "person", handle="_i0004", id="_I0004")
        ET.SubElement(person, NSP + "gender").text = "M"
        name = ET.SubElement(person, NSP + "name", type="Birth Name")
    ...
    def test_ldsord(self):
        ...
        ldsord = ET.SubElement(person, NSP + "lds_ord", type="sealed_to_parents")
        ET.SubElement(ldsord, NSP + "sealed_to", hlink="_f0001")
        parentin = input_ctxt.xpath(
            "//g:person[@handle='_i0000']/g:parentin", namespaces={"g": NS_G}
        )[0]
