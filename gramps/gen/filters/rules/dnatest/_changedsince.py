...
class ChangedSince(ChangedSinceBase):
    """Rule that checks for DNA tests changed since a specific time."""

    labels = [_("Changed after:"), _("but before:")]
    name = _("DNA tests changed after <date time>")
    description = _(
        "Matches DNA test records changed after a specified "
