...
* [**pango**](https://www.pango.org/) - a library for laying out and rendering of text, with an emphasis on internationalization.
* [**pangocairo**](https://www.pango.org/) - Allows you to use Pango with Cairo.
* [**librsvg2**](https://live.gnome.org/LibRsvg) - (SVG icon view) a library to render SVG files using cairo.
