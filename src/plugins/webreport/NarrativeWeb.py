...
class PlacePages(BasePage):
    ...
    def PlaceListPage(self, report, title, place_handles, db_place_handles):
        self.dbase_ = report.database
        BasePage.__init__(self, report, title)
...
class SourcePages(BasePage):
    ...
    def SourcePage(self, report, title, src_handle, src_list, ppl_handle_list,
                                        database_handles_list):
        self.dbase_ = report.database
...
class MediaPages(BasePage):
    ...
    def display_pages(self, report, title, db_media_handles, source_list):
        ...
        self.MediaListPage(report, report.title, db_media_handles)
    ...
    def MediaListPage(self, report, title, db_media_handles):
        self.dbase_ = report.database
        BasePage.__init__(self, report, title)
